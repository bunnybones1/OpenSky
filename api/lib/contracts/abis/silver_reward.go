...
var SilverRewardFactory ethartifact.Artifact

func init() {
	SilverRewardFactory = ethartifact.Artifact{
		ContractName: "SilverRewardFactory",
		ABI:          ethcontract.MustParseABI(silverRewardFactoryABIJSON),
	}
}

var silverRewardFactoryABIJSON = `[
    {
      "inputs": [
        {
