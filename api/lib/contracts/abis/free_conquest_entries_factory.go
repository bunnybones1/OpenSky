...
var FreeConquestEntriesFactory ethartifact.Artifact

func init() {
	FreeConquestEntriesFactory = ethartifact.Artifact{
		ContractName: "SW_FREE_CONQUEST_ENTRIES_FACTORY",
		ABI:          ethcontract.MustParseABI(freeConquestABIJSON),
	}
}

var freeConquestABIJSON = `[
    {
      "inputs": [
        {
