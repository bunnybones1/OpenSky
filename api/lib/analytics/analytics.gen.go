...
func WebRPCSchemaHash() string {
	return "488e06c4857e980c70ec8180ffc9a8403e95a57f"
}
...
const (
	...
	EventType_ACCOUNT_CREATED               EventType = 2
	EventType_ACCOUNT_LEVELED_UP            EventType = 3
	EventType_ACCOUNT_STATUS_UPDATED        EventType = 4
	EventType_CONQUEST_TICKET_MINTED        EventType = 5
	EventType_GOT_CONQUEST_POINTS           EventType = 6
	EventType_GOT_TREASURE_REWARD           EventType = 7
	EventType_MATCH_ENDED                   EventType = 8
	EventType_MATCH_GOT_REWARD              EventType = 9
	EventType_MATCH_STARTED                 EventType = 10
	EventType_QUEST_COMPLETED               EventType = 11
	EventType_QUEST_COMPLETION_CLAIMED      EventType = 12
	EventType_QUEST_REROLLED                EventType = 13
	EventType_SKYPASS_PURCHASED             EventType = 14
	EventType_SKYPASS_REWARD_CLAIMED        EventType = 15
	EventType_TUTORIAL_ENDED                EventType = 16
	EventType_TUTORIAL_STATUS_UPDATED       EventType = 17
	EventType_CLIENT_ATTEMPTING_NEW_ACCOUNT EventType = 18
)

var EventType_name = map[uint64]string{
	0:  "INIT",
	1:  "VIEW",
	2:  "ACCOUNT_CREATED",
	3:  "ACCOUNT_LEVELED_UP",
	4:  "ACCOUNT_STATUS_UPDATED",
	5:  "CONQUEST_TICKET_MINTED",
	6:  "GOT_CONQUEST_POINTS",
	7:  "GOT_TREASURE_REWARD",
	8:  "MATCH_ENDED",
	9:  "MATCH_GOT_REWARD",
	10: "MATCH_STARTED",
	11: "QUEST_COMPLETED",
	12: "QUEST_COMPLETION_CLAIMED",
	13: "QUEST_REROLLED",
	14: "SKYPASS_PURCHASED",
	15: "SKYPASS_REWARD_CLAIMED",
	16: "TUTORIAL_ENDED",
	17: "TUTORIAL_STATUS_UPDATED",
	18: "CLIENT_ATTEMPTING_NEW_ACCOUNT",
}

var EventType_value = map[string]uint64{
	"INIT":                          0,
	"VIEW":                          1,
	"ACCOUNT_CREATED":               2,
	"ACCOUNT_LEVELED_UP":            3,
	"ACCOUNT_STATUS_UPDATED":        4,
	"CONQUEST_TICKET_MINTED":        5,
	"GOT_CONQUEST_POINTS":           6,
	"GOT_TREASURE_REWARD":           7,
	"MATCH_ENDED":                   8,
	"MATCH_GOT_REWARD":              9,
	"MATCH_STARTED":                 10,
	"QUEST_COMPLETED":               11,
	"QUEST_COMPLETION_CLAIMED":      12,
	"QUEST_REROLLED":                13,
	"SKYPASS_PURCHASED":             14,
	"SKYPASS_REWARD_CLAIMED":        15,
	"TUTORIAL_ENDED":                16,
	"TUTORIAL_STATUS_UPDATED":       17,
	"CLIENT_ATTEMPTING_NEW_ACCOUNT": 18,
}

func (x EventType) String() string {
	return EventType_name[uint64(x)]
}

func (x EventType) MarshalJSON() ([]byte, error) {
	buf := bytes.NewBufferString(`"`)
	buf.WriteString(EventType_name[uint64(x)])
	buf.WriteString(`"`)
