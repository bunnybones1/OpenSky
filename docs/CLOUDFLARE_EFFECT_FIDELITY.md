...
| Main Worker's one-minute fan-out                                                                                  | Redesign incrementally      | Conquest V2, leaderboard, SkyPass, and referral-sticker cron work only discovers/recovers deterministic Workflows, while delayed Gold and external push only re-drive due D1 receipts to Queues; remaining unrelated responsibilities retain individual target boundaries. |
