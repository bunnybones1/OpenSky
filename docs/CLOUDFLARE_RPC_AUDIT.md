...
| --- | ---: |
| Source Go RPCs | 172 |
| Ported source RPCs | 116 |
| Remaining source RPCs | 56 |
...
| --- | ---: | --- |
| Admin and operations | 26 | Remaining reads can build on deployed RBAC; writes require granular authorization and immutable audits. |
