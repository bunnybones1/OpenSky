...
class TestSparksScene extends BaseTestScene {
  ...
  update(dt: number) {
    ...
    if (this._sparks) {
      for (const fountain of this._fountainEmitters) {
        ...
        fountain.update(fountain.position, fountain.quaternion, 0, 1000)
      }
...
export const scene = TestSparksScene
