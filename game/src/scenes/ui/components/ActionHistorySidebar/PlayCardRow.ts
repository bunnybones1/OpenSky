...
export default class PlayCardRow extends Row {
  mesh: Mesh2D
  ...
  constructor(
    ...
    const thumbUrl = getThumbnail(card)
    ...
    // this.mesh.matrix.setColor(new Color('red'))
    this.material = this.mesh.material as RowArtMeshMaterial

    // this.mesh.scale.multiplyScalar(ROW_SCALE)
    // this.mesh.matrix.setConstraints(
    //   Pin.fromPixels(ROW_WIDTH, ROW_HEIGHT),
    //   ReadonlyPin.Center,
    //   ReadonlyPin.Center.cloneOffset(-30, 30)
    // )
