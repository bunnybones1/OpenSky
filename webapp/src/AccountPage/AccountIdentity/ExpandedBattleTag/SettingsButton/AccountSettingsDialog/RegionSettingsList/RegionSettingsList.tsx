...
import { RegionSettingsRegions } from './RegionSettingsRegions/RegionSettingsRegions'

interface RegionSettingsListProps {
  returnToDefaultPage: () => void
}

export const RegionSettingsList = memo(
  ({ returnToDefaultPage }: RegionSettingsListProps) => {
        ...
        >
          <Box height={36} width={252}>
            <Input
              ...
              placeholder={t(`profile.regionSearch`)}
              rounded={true}
              autoFocus={true}
              submitDisabled={true}
...
RegionSettingsList.displayName = 'RegionSettingsList'
