...
interface MatchMakerWidgetLogo2Props {
  color: MatchMakerColorType
}

export const MatchMakerWidgetLogo2 = memo(({ color }: MatchMakerWidgetLogo2Props) => (
  <motion.svg
  ...
  >
    ...
    <path
      ...
      fill="url(#logo-2-paint-1)"
    />
    <path
      d="M23.9688 6.77066L30.7344 13.5513L32.7302 15.5524L35.2768 18.1047L37.9375 17.0007L23.9688 3V6.77066Z"
      fill="url(#logo-2-paint-2)"
    />
    <defs>
      <linearGradient
        id="logo-2-paint-1"
...
MatchMakerWidgetLogo2.displayName = 'MatchMakerWidgetLogo2'
