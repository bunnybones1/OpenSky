...
interface MatchMakerWidgetLogo3Props {
  color: MatchMakerColorType
}

export const MatchMakerWidgetLogo3 = memo(({ color }: MatchMakerWidgetLogo3Props) => (
  <motion.svg
  ...
  >
    ...
    />
    <path
      d="M32.7927 15.5524L35.3401 18.1046L38 17.0006L24.0312 2.99996L24.0312 6.77062L30.7978 13.5513L32.7927 15.5524Z"
      fill="url(#logo-3-paint-1)"
    />
    <path
      d="M38 36.9991L38 17.0005L35.3401 18.1045L35.3401 35.8951L38 36.9991Z"
      fill="url(#logo-3-paint-2)"
    />
    <defs>
      <linearGradient
        id="logo-3-paint-1"
...
MatchMakerWidgetLogo3.displayName = 'MatchMakerWidgetLogo3'
