...
export const LoadIcon = styled('svg')`
  animation: 3s ${AppLoadAnim} ease-in-out infinite;
`

export const LogoLoadingIcon = memo(() => {
  return (
    <LoadIcon
      height="200px"
      viewBox="0 0 36 62"
    ...
    >
      <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="logo_path" transform="translate(-14.000000, -1.000000)" fill="#FFFFFF">
...
LogoLoadingIcon.displayName = 'LogoLoadingIcon'
