...
export const CloseCircled = memo(({ color, height }: IconSVGProps) => (
  <IconSVG boxWidth={174.239} boxHeight={174.239} color={color} height={height}>
    <g>
      <path
...
CloseCircled.displayName = 'CloseCircled'
