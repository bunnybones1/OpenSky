...
export interface LegacyHeroFactoryInterface extends utils.Interface {
    functions: {
...
export interface LegacyHeroFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LegacyHeroFactoryInterface;
