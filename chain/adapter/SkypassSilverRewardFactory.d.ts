...
export interface SkypassSilverRewardFactoryInterface extends utils.Interface {
    functions: {
...
export interface SkypassSilverRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SkypassSilverRewardFactoryInterface;
