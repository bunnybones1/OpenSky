...
export interface LeaderboardRewardFactoryInterface extends utils.Interface {
    functions: {
...
export interface LeaderboardRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LeaderboardRewardFactoryInterface;
