...
export interface SkypassStickersFactoryInterface extends utils.Interface {
    functions: {
...
export interface SkypassStickersFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SkypassStickersFactoryInterface;
