...
export interface SilverRewardFactoryInterface extends utils.Interface {
    functions: {
...
export interface SilverRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SilverRewardFactoryInterface;
