...
export interface OpenSkyPaymentProxyInterface extends utils.Interface {
    functions: {
...
export interface OpenSkyPaymentProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OpenSkyPaymentProxyInterface;
