...
export interface CardbacksFactoryInterface extends utils.Interface {
    functions: {
...
export interface CardbacksFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CardbacksFactoryInterface;
