...
export interface ConquestTreasureSilverFactoryInterface extends utils.Interface {
    functions: {
...
export interface ConquestTreasureSilverFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConquestTreasureSilverFactoryInterface;
