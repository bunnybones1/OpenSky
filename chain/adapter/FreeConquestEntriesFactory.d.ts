...
export interface FreeConquestEntriesFactoryInterface extends utils.Interface {
    functions: {
...
export interface FreeConquestEntriesFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FreeConquestEntriesFactoryInterface;
