...
export interface ConquestPointsGoldRewardFactoryInterface extends utils.Interface {
    functions: {
        ...
        "openskyAssets()": FunctionFragment;
        "supportsInterface(bytes4)": FunctionFragment;
        "updatePeriodMintLimit(uint256)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "PERIOD_LENGTH" | "assignOwnership" | "batchMint" | "disableMint" | "enableMint" | "getAvailableSupply" | "getOwnerTier" | "livePeriod" | "mintWhitelist" | "periodMintLimit" | "openskyAssets" | "supportsInterface" | "updatePeriodMintLimit"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "openskyAssets", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "openskyAssets", data: BytesLike): Result;
...
export interface ConquestPointsGoldRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConquestPointsGoldRewardFactoryInterface;
    ...
    functions: {
        ...
        openskyAssets(overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        periodMintLimit(overrides?: CallOverrides): Promise<BigNumber>;
        openskyAssets(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        openskyAssets(overrides?: CallOverrides): Promise<PopulatedTransaction>;
