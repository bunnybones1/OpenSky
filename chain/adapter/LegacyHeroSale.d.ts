...
export interface LegacyHeroSaleInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "assignOwnership" | "getMintingCost" | "getMintingTotalCost" | "getOwnerTier" | "mintedAmounts" | "onERC1155BatchReceived" | "onERC1155Received" | "openskyAssets" | "supportsInterface" | "usdc" | "usdcCost" | "usdcCurve" | "usdcTotalCost" | "withdrawERC20"): FunctionFragment;
...
export interface LegacyHeroSale extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LegacyHeroSaleInterface;
