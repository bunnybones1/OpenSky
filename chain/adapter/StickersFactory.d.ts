...
export interface StickersFactoryInterface extends utils.Interface {
    functions: {
...
export interface StickersFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StickersFactoryInterface;
