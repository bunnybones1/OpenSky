...
export interface LeaderboardTicketRewardFactoryInterface extends utils.Interface {
    functions: {
...
export interface LeaderboardTicketRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LeaderboardTicketRewardFactoryInterface;
