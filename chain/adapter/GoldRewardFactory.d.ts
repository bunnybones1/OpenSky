...
export interface GoldRewardFactoryInterface extends utils.Interface {
    functions: {
...
export interface GoldRewardFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GoldRewardFactoryInterface;
