...
export interface SkypassConquestTicketsFactoryInterface extends utils.Interface {
    functions: {
...
export interface SkypassConquestTicketsFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SkypassConquestTicketsFactoryInterface;
